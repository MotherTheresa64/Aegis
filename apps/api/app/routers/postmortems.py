...
from ..models import Incident, Postmortem, Role, Service, User
...
async def get_postmortem(
    ...
    incident = await db.scalar(select(Incident).where(Incident.id == incident_id, Incident.organization_id == organization_id))
    if incident is None:
